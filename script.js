...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (document.querySelector('.home')) {
        ...
        document.querySelector('#home-name').textContent = portfolioData.name || 'Your Name';
        document.querySelector('#about-name').textContent = portfolioData.name || 'Your Name';
        document.querySelector('#contact-name').textContent = portfolioData.name || 'Your Name';
        document.querySelector('#footer-name').textContent = portfolioData.name || 'Your Name';
        ...
        document.querySelector('.sub-title').textContent = portfolioData.address || 'Your City, Country';
        ...
        document.querySelector('#about-para').textContent = portfolioData.quote || 'Your bio will appear here.';
